...
# Title: Dsb Tx
# Generated: Sat Mar 31 23:49:33 2018
##################################################
...
class dsb_tx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Dsb Tx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Dsb Tx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "dsb_tx")
        ...
        self.index_of_mod = blocks.multiply_const_vff((.3, ))
        self.freq_info = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0)
        ...
        self.connect((self.freq_info, 0), (self.index_of_mod, 0))
        self.connect((self.index_of_mod, 0), (self.carrier_amp, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_info.set_sampling_freq(self.samp_rate)
        self.analog_sig_source_x_0.set_sampling_freq(self.samp_rate)


def main(top_block_cls=dsb_tx, options=None):
