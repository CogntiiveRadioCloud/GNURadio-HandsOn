...
# Generated: Sat Mar 31 23:44:07 2018
##################################################
...
class wbfm_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, samp_rate=400e3):
        ...
        self.uhd_usrp_source_0.set_center_freq(91e6, 0)
        self.uhd_usrp_source_0.set_gain(50, 0)
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, samp_rate, 200e3, 30e3, firdes.WIN_HANN, 6.76))
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_float*1, '', False)
